 ...
 */
final class Version20240528085111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP title, DROP description, CHANGE deleted_at deleted_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD title VARCHAR(255) NOT NULL, ADD description LONGTEXT NOT NULL, CHANGE deleted_at deleted_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE education CHANGE image_name image_name VARCHAR(100) DEFAULT \'NULL\', CHANGE omc_code omc_code VARCHAR(100) DEFAULT \'NULL\', CHANGE deleted_at deleted_at DATETIME DEFAULT \'NULL\'');
