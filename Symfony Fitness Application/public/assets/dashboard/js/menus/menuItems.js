...
class MenuItems {
    ...
    handleEvents() {
        ...
        this.menuItemsForm.on('keypress', function(e) {
    ...
    handleAddMenuItem() {
        ...
        fetch(window.addMenuItemEndpoint, {
            ...
            .then(data => {
                KTSwal.showSwal(data.message, data.success ? 'success' : 'error')
     ...
     * @param data
     */
    handlePopulateEditForm(data, checked) {
