...
// Class definition
let KTDatatableCertifications = function () {
    // Shared variables
    let table;
    let datatable;
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/certificate/${row.uuid}/edit" class="menu-link px-3">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/certificate/${row.uuid}/delete" class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/certificate/${row.uuid}/delete">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    return {
        init: function (role) {
            table = document.querySelector('#kt_datatable_certifications');
...
KTUtil.onDOMContentLoaded(function () {
    KTDatatableCertifications.init();
});
