...
class PageWidgetRepository extends ServiceEntityRepository
{
    ...
    public function add(PageWidget $entity, bool $flush = false): void
    {
...
//    /**
//     * @return PageWidget[] Returns an array of PageWidget objects
//     */
...
//    public function findOneBySomeField($value): ?PageWidget
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
