...
class SmartBillAPIHelper
{
     ...
     */
    public function __construct(string $cif, string $invoiceSeriesName, string $username, string $token, string $baseUrl, LoggerInterface $smartbillLogger)
    {
        $this->cif = $cif;
     ...
     * @throws Exception
     */
    private function sendRequest(string $method, string $endpoint, string $seriesName = '', array $data = [], array $extraHeaders = [], bool $decodeResult = true)
    {
    ...
    public function populateData(Payment $payment): array
    {
        ...
        return [
            ...
            'products' => [
                [
                    'name' => $payment->getMembershipPackage()->getName(),
