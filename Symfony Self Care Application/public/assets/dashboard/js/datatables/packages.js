...
let KTDatatable = function () {
    ...
    let initDatatable = function (role) {
        datatable = $(table).DataTable({
            ...
            ajax: {url: window.packageAjaxPath},
            columns: [
                {data: 'id'},
                {data: 'name'},
                {data: 'slug'},
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: 'text-center',
                    render: function (data, type, row) {
                        return `<a href="${window.packageImagePath}${data}" target="_blank">
                                    <img src="${window.packageImagePath}${data}" alt="image" class="w-100px">
                                </a>`;
                    }
                },
                {
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/secure/membership-package/${row.uuid}/edit?locale=ro" class="menu-link px-3">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="moderate" data-action="/dashboard/secure/membership-package/actions/moderate/${row.uuid}" data-name="${row.status}">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/secure/membership-package/actions/remove/${row.uuid}">
