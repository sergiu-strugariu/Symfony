...
// Class definition
let KTDatatablePartners = function () {
    // Shared variables
    let table;
    let datatable;
    ...
    let initDatatable = function () {
        datatable = $(table).DataTable({
            ...
            ajax: {url: window.partnerAjaxPath},
            columns: [
                {data: 'id'},
                {data: 'name'},
                {data: 'type'},
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        return `<span class="badge badge-${row.type === window.partnerSponsorType ? 'info' : 'primary'} rounded-0">${data}</span>`;
                    }
                },
                {
                    targets: 3,
                    ...
                    className: 'text-center',
                    render: function (data, type, row) {
                        return `<a href="${window.partnerImagePath}${data}" target="_blank">
                                    <img src="${window.partnerImagePath}${data}" alt="image" class="w-100px">
                                </a>`;
                    }
                },
                {
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/event/partner/${row.uuid}/edit?locale=ro" class="menu-link px-3">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/event/partner/actions/remove/${row.uuid}">
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_datatable_partners');
