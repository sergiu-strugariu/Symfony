...
// Class definition
let KTDatatableArticles = function () {
    // Shared variables
    let table;
    let datatable;
    ...
    let initDatatable = function (role) {
        datatable = $(table).DataTable({
            ...
            ajax: {url: window.articleAjaxPath},
            columns: [
                {data: 'id'},
                {data: 'title'},
                {data: 'slug'},
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (row.status === window.published) {
                            dataValue = `<a href="${window.singleArticlePath}/${row.slug}" target="blank" class="custom-link">${data}</a>`;
                        }
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/article/${row.uuid}/edit?locale=ro" class="menu-link px-3">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="moderate" data-action="/dashboard/article/actions/moderate/${row.uuid}" data-name="${row.status}">
                                ...
                                <div class="menu-item px-3 ${window.isAdmin ? '' : 'd-none'}">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/article/actions/remove/${row.uuid}">
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_datatable_articles');
