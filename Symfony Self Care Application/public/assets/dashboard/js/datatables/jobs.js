...
let KTDatatableJobs = function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (row.status === window.published) {
                            dataValue = `<a href="${window.singleJobPath}/${row.slug}" target="blank" class="custom-link">${data}</a>`;
                        }
                ...
                },
                {
                    ...
                    className: 'text-center',
                    render: function (data, type, row) {
                        return `<span class="badge badge-${data === 'Part-Time' ? 'secondary' : 'dark'} rounded-0">${data}</span>`;
                    }
                },
                {
                    targets: 6,
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/job/${row.uuid}/edit?locale=ro" class="menu-link px-3">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="moderate" data-action="/dashboard/job/actions/moderate/${row.uuid}" data-name="${row.status}">
                                ...
                                <div class="menu-item px-3 ${window.isAdmin ? '' : 'd-none'}">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/job/actions/remove/${row.uuid}">
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_datatable_jobs');
