...
let KTDatatableMenus = function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        return `<span class="badge badge-info rounded-0">${data}</span>`;
                    }
                },
                {
                    targets: 4,
                    ...
                    className: 'text-center',
                    render: function (data, type, row) {
                        return `<a href="/dashboard/menu/item/${row.uuid}/view?locale=ro">${window.translations.dashboard.actions.manage_links}</a>`;
                    }
                },
                {
                    targets: -1,
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/menu/${row.uuid}/edit?locale=ro" class="menu-link px-3">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/menu/${row.uuid}/delete">
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_datatable_menus');
