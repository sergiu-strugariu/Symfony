...
let KTDatatablePages = function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        return `<a href="${row.url}" target="blank" class="custom-link">${data}</a>`;
                    }
                },
                {
                    targets: -1,
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/page/${row.machineName}/edit-view?locale=ro" class="menu-link px-3">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/page/${row.machineName}/delete">
    ...
    return {
        init: function (role) {
            table = document.querySelector('#kt_datatable_pages');
