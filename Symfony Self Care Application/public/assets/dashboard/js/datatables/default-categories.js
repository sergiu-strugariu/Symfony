...
// Class definition
let KTDatatableDefaultCategories = function () {
    // Shared variables
    let table;
    let datatable;
    ...
    let initDatatable = function () {
        datatable = $(table).DataTable({
            ...
            ajax: {url: window.categoryAjaxPath},
            columns: [
                {data: 'id'},
                {data: 'title'},
                {data: 'slug'},
                        ...
                        let template = `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/category/${row.uuid}/edit/${window.categoryType}/?locale=ro" class="menu-link px-3">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="moderate" data-action="/dashboard/category/actions/moderate/${row.uuid}/${window.categoryType}" data-name="${row.status}">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-table-action="delete" data-action="/dashboard/category/actions/remove/${row.uuid}/${window.categoryType}">
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_datatable_default_categories');
...
KTUtil.onDOMContentLoaded(function () {
    KTDatatableDefaultCategories.init();
});
