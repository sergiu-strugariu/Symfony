...
class TrainingCourseFormType extends AbstractType
{
    /**
     * @var CityRepository
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('categoryCourses', EntityType::class, [
                'class' => CategoryCourse::class,
                ...
                'query_builder' => function (EntityRepository $er) {
                    return $er->createQueryBuilder('c')
                        ...
                        ->setParameter('published', CategoryCourse::STATUS_PUBLISHED)
                        ->orderBy('c.id', 'ASC');
                },
                'choice_label' => function (CategoryCourse $categoryCourse) use ($language) {
                    $collection = $categoryCourse->getCategoryCourseTranslations()->filter(function ($translation) use ($language) {
            ...
            ->add('duration', TextType::class, [
                'required' => true,
                'mapped' => false,
                'data' => !empty($translation) ? $translation->getDuration() : '',
                'constraints' => [
                    new Assert\NotBlank([
                        'message' => 'dashboard.form.field_mandatory'
                    ])
            ...
            ->add('format', ChoiceType::class, [
                ...
                'choices' => TrainingCourse::getFormats()
            ])
            ...
            ->add('certificate', TextType::class, [
                'required' => true,
                'mapped' => false,
                'data' => !empty($translation) ? $translation->getCertificate() : '',
                'constraints' => [
                    new Assert\NotBlank([
                        'message' => 'dashboard.form.field_mandatory'
                    ])
            ...
            ->add('minParticipant', IntegerType::class, [
                'required' => true,
                'constraints' => [
                    new Assert\NotBlank([
                        'message' => 'dashboard.form.field_mandatory'
    ...
    public function onPostSubmit(FormEvent $event): void
    {
        ...
        $min = $data->getMinParticipant();
        $max = $data->getMaxParticipant();

        if ($min !== null && $max !== null && $min >= $max) {
            $form->get('minParticipant')->addError(new FormError($this->translator->trans('dashboard.form.min_start_number', [], 'messages')));
        }
    }
