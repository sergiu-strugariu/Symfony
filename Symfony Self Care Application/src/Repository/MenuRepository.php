...
class MenuRepository extends ServiceEntityRepository
{
     ...
     */
    public function countMenus(): float|bool|int|string|null
    {
     ...
     * @return array
     */
    public function findMenusByFilters(string $column, string $dir, $keyword, DateTimeInterface $startDate = null, DateTimeInterface $endDate = null): array
    {
        $queryBuilder = $this->createQueryBuilder('m')
            ->select("
                ...
                m.title,
                m.machineName,
                DATE_FORMAT(m.createdAt, '%d-%m-%Y %H:%i') as createdAt"
            )
            ->where('m.deletedAt IS NULL');
